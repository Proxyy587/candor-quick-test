	...
	return (
		...
		>
			...
			>
				{items.map((item, idx) => (
					<li
						className="w-[200px] max-w-full relative rounded-xl border border-b-0 flex-shrink-0 border-slate-700 px-2 py-2 md:w-[300px]"
						style={{
							background:
					...
					>
						<blockquote>
							...
							></div>
							<span className="relative z-20 text-xs leading-[1.4] text-gray-100 font-normal">
								{item.quote}
							</span>
